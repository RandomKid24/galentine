    ...
    return (
        <div className="mt-8 space-y-8 animate-entrance">
            ...
            <div className="space-y-6">
                <h4 className="text-[17px] font-medium text-gray-800">Additional Guest Details</h4>
                
                <div className="space-y-6">
                    {Array.from({ length: count - 1 }).map((_, i) => (
                        <div key={i} className="space-y-2">
                            <label className="text-[15px] font-medium text-gray-700">Guest {i + 2} Name <span className="text-red-500">*</span></label>
                            <input
                                type="text"
                                required
                                value={names[i] || ''}
