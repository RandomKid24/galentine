...
/**
 * Header Component
 * Displays the hero section of the landing page, including:
 * - Animated background elements (blobs)
 * - Main title and subtitle with entrance animations
 * - "Secure Your Spot" call-to-action button
 * - Hero image with styling
 */
const Header: React.FC = () => {
    /**
     * Smooth scrolls the page to the registration form section.
     */
