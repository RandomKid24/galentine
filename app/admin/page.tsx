    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Stat Card 1 */}
                <div className="bg-white p-4 rounded-2xl border border-rose-100 shadow-sm hover:shadow-md transition-all group">
                    ...
                    <p className="text-3xl font-serif font-bold text-rose-950">
                ...
                <div className="bg-white p-4 rounded-2xl border border-rose-100 shadow-sm hover:shadow-md transition-all group">
                    ...
                    <h3 className="text-rose-900/60 font-bold text-xs uppercase tracking-wider mb-1">Recent Activity</h3>
                    <p className="text-3xl font-serif font-bold text-rose-950">
                        {loading ? '...' : (registrations.length > 0 ? 'Live' : 'Silent')}
                    </p>
                </div>
