        ...
        if (!configError && configData) {
            ...
            if (settings.host && settings.username && settings.password) {
                ...
                await transporter.sendMail({
                    ...
                    to: email,
                    subject: `Registration Received - Galentine's 2026 🌸`,
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; border: 1px solid #fecdd3; border-radius: 16px; background-color: #ffffff; color: #4c0519;">
                            <div style="text-align: center; margin-bottom: 30px;">
                                <h1 style="color: #be123c; font-size: 24px; margin-bottom: 8px;">Registration Received</h1>
                            ...
                            <p style="font-size: 16px; line-height: 1.5;">We have received your registration and payment receipt for Galentine's 2026. Our team will verify your payment and confirm your seat shortly.</p>
                            
                            <div style="background-color: #fff9fb; border: 1px solid #ffe4e6; border-radius: 12px; padding: 20px; margin: 30px 0;">
                                <h3 style="margin-top: 0; color: #be123c; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 15px; border-bottom: 1px solid #ffe4e6; padding-bottom: 10px;">Registration Summary</h3>
                                
                                <div style="margin-bottom: 10px;">
                                    <span style="color: #db2777; font-weight: bold; font-size: 13px;">Guest:</span>
                                    <span style="font-size: 13px; margin-left: 10px;">${fullName}</span>
                                </div>
                                
                                <div style="margin-bottom: 10px;">
                                    <span style="color: #db2777; font-weight: bold; font-size: 13px;">Selected Pass:</span>
                                    <span style="font-size: 13px; margin-left: 10px;">${passData?.title || 'General Entry'}</span>
                                </div>

                                ${additionalNames && additionalNames.length > 0 ? `
                                <div style="margin-top: 10px; border-top: 1px solid #ffe4e6; pt-10;">
                                    <p style="color: #db2777; font-weight: bold; font-size: 13px; margin-bottom: 5px;">Additional Guests:</p>
                                    <div style="font-size: 12px; color: #4c0519;">
                            ...
                            <div style="background-color: #fff1f2; border-left: 4px solid #be123c; padding: 15px; border-radius: 4px; margin-bottom: 25px;">
                                <p style="margin: 0; color: #9f1239; font-size: 14px; line-height: 1.5;"><strong>Next Step:</strong> We are currently verifying your payment receipt. You will receive a separate confirmation email with your <strong>Unique Entry Key</strong> once verified.</p>
                            </div>

                            <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #f3f4f6; text-align: center;">
                                <p style="font-size: 12px; color: #9f1239; font-weight: bold;">sharedsmilesco</p>
