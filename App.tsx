            ...
            <form onSubmit={handleSubmit} className="space-y-10 md:space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[9px] md:text-[10px] font-bold text-rose-500 uppercase tracking-[0.2em] md:tracking-[0.25em] px-1">Mobile Number</label>
                    <input required type="tel" name="phone" value={formData.phone} onChange={handleInputChange} placeholder="10-digit number" className={inputClasses} maxLength={10} />
                  </div>
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-[9px] md:text-[10px] font-bold text-rose-500 uppercase tracking-[0.2em] md:tracking-[0.25em] px-1">Email Address</label>
                    <input required type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="hello@friend.com" className={inputClasses} />
                  </div>
                </div>
              </div>
